...
<Page name="home">
  ...
  <Navbar large sliding={false}>
    ...
    <NavTitle sliding>portfolio</NavTitle>
    <NavRight>
      <Link iconIos="f7:menu" iconAurora="f7:menu" iconMd="material:menu" panelOpen="right" />
    </NavRight> -->
    <NavTitleLarge>Ricardo's Hutt</NavTitleLarge>
  </Navbar>
  ...
  <Block strong>
    ...
    <img
      src="https://flowms-live.s3.amazonaws.com/avatars/RicardoBento17606/resized/80/me-avatar.png"
      alt="" />
    <p>
  ...
  <Block strong>
    <Row>
      <Col width="100">
        <Button fill raised popupOpen="#cv-popup">Open CV Modal</Button>
      </Col>
      <!-- <Col width="50">
